  ...
  return (
    <main className="about-me">
      ...
      <div className="contact-icons">
        <a href="mailto:leighchad.cl@gmail.com" target="_blank" rel="noreferrer">
        ...
        <a href="https://github.com/El-Potato-Slayer?tab=repositories" target="_blank" rel="noreferrer">
          <svg className="icon" viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="https://www.linkedin.com/in/chad-leigh-van-wyk/" target="_blank" rel="noreferrer">
          <svg className="icon" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 382 382">
        ...
        <a href="https://twitter.com/ElPotatoSlayer" target="_blank" rel="noreferrer">
          <svg className="icon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512">
